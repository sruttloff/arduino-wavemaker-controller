...
Die Gleichspannung wird über den OP verstärkt und liefert am OP Ausgang 0-9V (oder 0-10V wenn man ein 10V Spannungsquelle hat).
Im Programm wird Pump1 als Master betrachtet und Pumpe 2 ist Slave. Wenn Pump1 auf 100% läuft, läuft Pumpe2 mit 0%.
Es gibt 4 Timings (siehe Bild) die man frei definieren kann. Auch ist 0% und 100% Leistung frei einstellbar (PWM Rate 0-255).
